  ...
  const tools: {
  ...
  }[] = [
    {
      ...
      items: [
        ...
        {
          name: "ND Reportable Conditions",
          desc: "Searchable list of all North Dakota mandatory reportable infectious and non-infectious conditions with reporting timeframes (immediate, 1 business day, 7 days) and reporting contacts. Updated December 2023 per NDAC 33-06 and NDCC 23-07.",
          chips: ["ND HHS", "~90 conditions"],
          href: "/reportable",
          color: "teal",
        },
        {
          name: "Naloxone Reference",
          desc: "Naloxone dosing by route (intranasal, IM, IV), high-potency opioid guidance, renarcotization warning, ND Good Samaritan law summary, standing order access, and ND overdose statistics.",
          chips: ["Opioid overdose", "ND law"],
          href: "/naloxone",
          color: "teal",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "qSOFA quick screen (3 criteria) with real-time score and sepsis risk interpretation. Full SOFA organ dysfunction scoring across 6 domains (respiration, coagulation, liver, cardiovascular, CNS, renal) with septic shock criteria.",
          chips: ["Sepsis-3", "qSOFA + SOFA"],
          href: "/sepsis",
          color: "indigo",
        },
        {
          name: "Wound & Tetanus Prophylaxis",
          desc: "Two-step decision tool: classify wound (clean/minor vs. tetanus-prone) + enter vaccination history → ACIP-based recommendation for Tdap/Td and/or TIG. Includes tetanus-prone wound criteria and product reference.",
          chips: ["ACIP", "Tdap / TIG"],
          href: "/wound",
          color: "amber",
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Empiric Therapy + Susceptibility",
          desc: "Select infection site and likely organism to see IDSA empiric regimens paired with local Trinity Hospital susceptibility rates side-by-side. Covers UTI, pneumonia, SSTI, sepsis, intra-abdominal, and epididymitis.",
          chips: ["Local antibiogram", "7 infection sites"],
          href: "/empiric",
          color: "green",
        },
        {
          name: "Antibiotic Allergy Cross-Reactivity",
          desc: "Select a reported allergy and proposed antibiotic to assess cross-reactivity risk. Covers penicillin, cephalosporin, carbapenem, and monobactam cross-reactions with side-chain similarity analysis based on IDSA/AAAAI guidance.",
          chips: ["Cross-reactivity", "Side-chain analysis"],
          href: "/allergy",
          color: "green",
        },
        {
          name: "STI Treatment Guidelines",
          desc: "CDC 2021 STI Treatment Guidelines — full recommended, alternative, and pregnancy-specific regimens for chlamydia, gonorrhea, syphilis, herpes, trichomoniasis, BV, vulvovaginal candidiasis, PID, epididymitis, scabies, and mpox. Searchable by diagnosis or drug.",
          chips: ["CDC 2021", "Pregnancy regimens", "12 conditions"],
          href: "/sti-guide",
          color: "green",
        },
        {
